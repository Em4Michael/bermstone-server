...
const URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/bermstone';
...
const PROPERTIES = [
  {
    ...
    pricePerNight: 85000, currency: 'NGN',
    ...
    isFeatured: true, isActive: true, bookingLink: 'https://wa.me/2348000000000',
  },
  {
    ...
    pricePerNight: 120000, currency: 'NGN',
  ...
  },
  {
    ...
    pricePerNight: 55000, currency: 'NGN', discounts: [],
    ...
    isFeatured: false, isActive: true, bookingLink: 'https://wa.me/2348000000000',
  },
  {
    ...
    pricePerNight: 250000, currency: 'NGN',
  ...
  },
  {
    ...
    pricePerNight: 35000, currency: 'NGN',
...
const INVESTMENTS = [
  {
    ...
    currency: 'NGN', projectType: 'skyscraper', status: 'active',
  ...
  },
  {
    ...
    currency: 'NGN', projectType: 'duplex', status: 'upcoming',
  ...
  },
  {
    ...
    currency: 'NGN', projectType: 'hotel', status: 'completed',
  ...
  },
  {
    ...
    currency: 'NGN', projectType: 'residential_complex', status: 'active',
...
async function seed() {
  ...
  const REVIEWS = [
    ...
    { name: 'Dr. Amaka Eze',    country: 'Nigeria', rating: 5, comment: 'Most professional keyneet operator in Nigeria. The Ocean View Studio is small but perfectly formed.', propIdx: 2 },
  ];
